...
Russia war on Ukraine had an impact to EU and Russia trade. The goal of this document is to give a bird's eye view of these changes. The data from Eurostat was used. 

## Main findings

1. Export to Russia dropped by `r round(abs(ru_data$egrowth[1]))`% after Russia invasion to Ukraine on February 24th.  Export to Russia neighbours increased by  `r round(nb_data$egrowth[1])`%.
